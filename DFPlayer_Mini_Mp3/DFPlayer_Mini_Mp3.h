...
public:
    ...
    static void mp3_set_serial (HardwareSerial &theSerial); 
    ...
    //set single loop 
    static void mp3_single_loop (boolean state); 

    static void mp3_single_play (uint16_t num); 

    //
    static void mp3_DAC (boolean state); 
...
private:
    ...
    static void mp3_set_reply (boolean state); 

    static void fill_uint16_bigend (uint8_t *thebuf, uint16_t data);

    static void mp3_fill_cmd (uint8_t cmd, uint16_t arg);
    static void mp3_fill_cmd (uint8_t cmd);
